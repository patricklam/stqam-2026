...
\lecture{23 --- March 30, 2026}{Winter 2026}{Patrick Lam}{version 1}
...
might be proving the wrong thing---misled by a wrong specification, as in our first bubble sort example). The other 3 participants sometimes trusted that their
...
\section*{Impact of Verification on Deployment}
...
Lack of trust in the transpiler was one reason they looked at transpiled code. Ensuring transpiling code quality was
