...
which is statically verified, we use \textsf{expect} to write what we expect (shout-out to Kieran from SE27 for finding this; the documentation on Dafny tests
is hard to find.)
