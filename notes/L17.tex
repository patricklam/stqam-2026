...
The code in the blog post for using libFuzzer or AFL doesn't actually work,
because these fuzzers give you bits, and you have to convert them into i32s yourself.
...
\end{verbatim}
Running \texttt{cargo test} is also supposed to do normal random testing.
...
and you can fix it. When Kani reports an unwinding error, then you don't know.
