...
% suggestion for improvement: it'd make more sense in context to have the input we're reducing fail on the given runner we have so that its an actual reduction, and then have a case still where having a generated NaN on a RHS of an expression or something can help us get to a minimum working example faster
