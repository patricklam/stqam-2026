...
Assignment 2, version 1.2X\footnote{version 1: initial release; version 1.1: added clarification in Q1c about being allowed to change \texttt{function\_coverage\_runner.py}; version 1.2: property-based testing question fix}}
\author{Patrick Lam \\
